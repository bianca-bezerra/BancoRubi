...
BEGIN 
    INSERT INTO CLIENTE (
        ...
        DT_NASC,
        TELEFONE
    ) VALUES(CPF,NOME,ENDERECO,DT_NASC,TELEFONE);
...
BEGIN 
	  SELECT GET_ID_BANCO(NOME_BANCO_) INTO ID_BANCO_;
...
---- COM TELEFONE
CREATE OR REPLACE FUNCTION INSERTO (ID_BANCO INTEGER,ENDERECO TEXT, TELEFONE_ TEXT) 
RETURNS VOID AS $$ 

BEGIN 
    INSERT INTO AGENCIA VALUES(DEFAULT, ID_BANCO,ENDERECO, TELEFONE_);
END; 
$$ 
LANGUAGE PLPGSQL;
...
BEGIN 
    ...
    SELECT GET_ID_BANCO(NOME_BANCO_) INTO ID_BANCO_;
    INSERT INTO AGENCIA VALUES(DEFAULT, ID_BANCO_,ENDERECO, TELEFONE_);
END; 
$$ 
LANGUAGE PLPGSQL;
